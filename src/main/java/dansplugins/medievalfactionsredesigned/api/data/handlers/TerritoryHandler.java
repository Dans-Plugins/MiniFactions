package dansplugins.medievalfactionsredesigned.api.data.handlers;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.google.gson.stream.JsonReader;
import dansplugins.medievalfactionsredesigned.MedievalFactions;
import dansplugins.medievalfactionsredesigned.api.data.JsonTerritoryChunk;
import dansplugins.medievalfactionsredesigned.api.definitions.core.TerritoryChunk;
import dansplugins.medievalfactionsredesigned.api.exceptions.TerritoryFileException;
...
public class TerritoryHandler {
    ...
    public TerritoryHandler() {
        file = new File(MedievalFactions.getInstance().getDataFolder(), "territory.json");
        try {
            if (!file.exists()) {
