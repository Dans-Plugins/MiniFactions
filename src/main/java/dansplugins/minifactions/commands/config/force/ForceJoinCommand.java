...
public class ForceJoinCommand extends AbstractMFCommand {
    ...
    public ForceJoinCommand(MFLogger mfLogger, MiniFactions miniFactions) {
        super(new ArrayList<>(Arrays.asList("join")), new ArrayList<>(Arrays.asList("mf.force.join")), mfLogger);
